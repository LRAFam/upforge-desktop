...
<template>
  <section class="relative overflow-hidden rounded-xl border border-white/10 bg-[#171719] p-5 sm:p-6">
    <img :src="TRAINING_ARTWORK.guidedSessionHero" alt="" aria-hidden="true" class="absolute right-0 top-0 h-full w-1/2 object-cover opacity-10 pointer-events-none" />
