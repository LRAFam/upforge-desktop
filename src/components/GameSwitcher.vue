<template>
  <div ref="rootRef" class="relative flex-shrink-0">
    ...
    <Transition name="game-menu">
      <div
        v-if="open"
        class="absolute left-0 top-[calc(100%+6px)] z-[120] min-w-[200px] overflow-hidden rounded-xl border border-white/[0.12] bg-[#121820] shadow-[0_20px_50px_rgba(0,0,0,0.55)]"
      >
        <p class="px-3 pt-2.5 pb-1 text-[9px] font-bold uppercase tracking-[0.22em] text-gray-600">Your game</p>
        <button
